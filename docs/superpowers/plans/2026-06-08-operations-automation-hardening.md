...
curl -fsSL https://www.cloudflare.com/ips-v4 -o "${TMP_DIR}/ips-v4"
curl -fsSL https://www.cloudflare.com/ips-v6 -o "${TMP_DIR}/ips-v6"

{
  ...
  echo "deny all;"
} > "${TMP_DIR}/cloudflare-origin-allow.conf"

install -m 0644 "${TMP_DIR}/cloudflare-origin-allow.conf" "${ALLOW_SNIPPET}"
